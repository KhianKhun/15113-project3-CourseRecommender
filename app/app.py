...
from app.core.recommender import compute_structural_matrix
...
if "initialized" not in st.session_state:
    with st.spinner("Loading course data and building graph..."):
        ...
        structural_matrix = compute_structural_matrix(courses)
        ...
        st.session_state.structural_matrix = structural_matrix
